          ...
          <div className="flex items-start space-x-5 p-5 bg-gradient-to-r from-muted/20 to-transparent rounded-xl border border-border/50">
            ...
            <div className="flex-1">
              <div className="flex items-start justify-between mb-3">
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-1">{booking?.venue?.name}</h3>
                  <div className="flex items-center space-x-2 text-text-secondary mb-2">
                    <Icon name="MapPin" size={14} />
                    <span>{booking?.venue?.location}</span>
                  </div>
                </div>
                <span className={`px-4 py-2 rounded-full text-sm font-medium border ${getStatusColor(booking?.status)} whitespace-nowrap`}>
                  {booking?.status}
                </span>
              </div>
              <div className="flex items-center space-x-6 text-sm text-text-secondary">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-medium">{booking?.venue?.rating}</span>
                </div>
                <div className="flex items-center space-x-2">
            ...
            <div className="bg-gradient-to-br from-primary/5 to-transparent p-5 rounded-xl border border-border/50">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between items-center py-1">
                  ...
                  <span className="text-foreground font-mono font-medium bg-muted px-2 py-1 rounded text-xs">{booking?.id}</span>
                </div>
                <div className="flex justify-between items-center py-1">
                  <span className="text-text-secondary">Date:</span>
                  <span className="text-foreground font-medium">{formatDate(booking?.date)}</span>
                </div>
                <div className="flex justify-between items-center py-1">
                ...
                <div className="flex justify-between items-center py-1">
                  ...
                  <span className="text-foreground font-medium">{booking?.duration} hours</span>
                </div>
                <div className="flex justify-between items-center py-1">
                  <span className="text-text-secondary">Court:</span>
                  <span className="text-foreground font-medium">{booking?.court}</span>
                </div>
                <div className="flex justify-between items-center py-1">
                  <span className="text-text-secondary">Sport:</span>
                  <span className="text-foreground font-medium">{booking?.sport}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-success/5 to-transparent p-5 rounded-xl border border-border/50">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between items-center py-1">
                  ...
                  <span className="text-foreground font-medium">${booking?.hourlyRate}</span>
                </div>
                <div className="flex justify-between items-center py-1">
                  <span className="text-text-secondary">Duration:</span>
                  <span className="text-foreground font-medium">{booking?.duration} hours</span>
                ...
                <div className="flex justify-between items-center py-1">
                  ...
                  <span className="text-foreground font-medium">${booking?.tax}</span>
                </div>
                ...
                <div className="flex justify-between items-center py-1">
                  ...
                  <span className="text-success font-medium bg-success/10 px-2 py-1 rounded text-xs">{booking?.paymentStatus}</span>
                </div>
                <div className="flex justify-between items-center py-1">
          ...
          <div className="bg-gradient-to-r from-warning/5 to-transparent p-5 rounded-xl border border-border/50">
            ...
            <div className="text-sm text-text-secondary space-y-1 leading-relaxed">
              <p className="flex items-start space-x-2">
                ...
                <span>Free cancellation up to 24 hours before the booking time</span>
              </p>
              <p className="flex items-start space-x-2">
