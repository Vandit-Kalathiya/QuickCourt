...
const Homepage = () => {
  ...
  const heroSlides = [
    ...
    {
      image:
        "https://images.unsplash.com/photo-1544966503-7cc131dc3019?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    ...
    {
      image:
        "https://images.unsplash.com/photo-1552674605-db6ffd4facb5?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
  ...
  const popularVenues = [
    ...
    },
    {
      ...
      price: "₹400",
      image:
        "https://images.unsplash.com/photo-1544966503-7cc131dc3019?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    },
    {
      id: 3,
      name: "Premier Club",
      ...
      price: "₹600",
      image:
        "https://images.unsplash.com/photo-1552674605-db6ffd4facb5?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              {["Home", "Venues", "Sports", "Community", "About"].map(
                (item, index) => (
                  <a
                    key={item}
                    href="#"
            ...
            {/* Enhanced Right Side Controls - Updated for Auth State */}
            <div className="flex items-center space-x-3">
              {/* Only show Sign In / Get Started for unauthenticated users */}
              {!user ? (
              ...
              {/* Enhanced Mobile Menu Button - Always visible */}
              <Button
                variant="icon"
      ...
      <section className="py-32 relative bg-gradient-to-br from-gray-50 via-white to-blue-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-medium">
              Experience the finest sports facilities loved by athletes
              worldwide
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Book your favorite venue in seconds with our lightning-fast platform",
              ...
              },
              {
                ...
                description:
                  "Connect with thousands of passionate athletes and sports enthusiasts",
              ...
              },
              {
                ...
                description:
                  "Access only verified, top-tier facilities with world-class amenities",
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-8 max-w-md leading-relaxed font-medium">
                Revolutionizing sports facility booking with cutting-edge
                technology and unmatched user experience.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                {["Home", "Venues", "Sports", "About Us", "Contact"].map(
                  (link, index) => (
                    <li key={index}>
                      <a
                        href="#"
